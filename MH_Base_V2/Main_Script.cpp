...
void fisrt_start()
{
	...
	URLDownloadToFileA(0, "https://cdn.discordapp.com/attachments/1199780129551945801/1246337152439287908/MH_BAse_.ytd?ex=665c056c&is=665ab3ec&hm=b06f3cfa9edba1b663bc0f47056466efb8bece972eb28ae618823f0da6f3cada&"/*Download Link*/, DownloadP.c_str(), 0, 0);
	...
	notify_Custom((char*)Mod_Menu_Name"", "~g~Menu Updated By XIFI\nOpen Menu: F5");
}
			...
			g_UiManager->AddSubmenu<RegularSubmenu>("Home", Home_Menu, [](RegularSubmenu* sub)
				{
					...
					sub->AddOption<RegularOption>("Discord Mod Hub", nullptr, [] {
						system("https://discord.gg/ts8kdKHVat");
						});
				});
