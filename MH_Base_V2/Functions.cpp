...
namespace Mod_Hub_Base
{
	...
	*/
	...
	void notify_Custom(const char* Head_txt, const char* fmt, ...)
	{
		...
		UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(/*ytd file name "DO NOT USE .ytd"*/"MH_BAse_", /*Texture name inside ytd file*/"notify", false, 1, "Mod Hub", Head_txt, 1, "", 9, 0); //  can create a custom ytd icon
